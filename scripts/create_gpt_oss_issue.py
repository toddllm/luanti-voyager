#!/usr/bin/env python3
"""Create GitHub issue for GPT-OSS integration research"""

import subprocess
import json

issue_title = "Research: Incorporate GPT-OSS Harmony Response Format into Luanti Voyager Agent Architecture"

issue_body = """## 🔬 Research Proposal: GPT-OSS Integration
...
cmd = [
    ...
    "--title", issue_title,
    "--body", issue_body,
    "--label", "research,enhancement,architecture,ai-models",
...
if result.returncode == 0:
    ...
    print("\nIssue content saved to: gpt_oss_issue.md")
    with open("gpt_oss_issue.md", "w") as f:
