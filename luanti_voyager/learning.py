...
class AdaptiveLearning:
    ...
    def analyze_failure(self, action: Dict[str, Any], world_before: Dict[str, Any], 
                       world_after: Dict[str, Any], error_type: ErrorType) -> Dict[str, Any]:
        """
        ...
        self.state['error_patterns'][error_key] = self.state['error_patterns'].get(error_key, 0) + 1
    ...
    def track_success(self, action: Dict[str, Any], world_before: Dict[str, Any], 
                     world_after: Dict[str, Any], efficiency: float = 1.0):
        """
        ...
        self.state['success_patterns'][success_key] = self.state['success_patterns'].get(success_key, 0) + 1
    ...
    def _extract_context(self, world_state: Dict[str, Any], action: Optional[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    def _update_strategy_weights(self, situation: str, success: bool, efficiency: float = 1.0):
    ...
    def _generate_alternatives(self, action: Dict[str, Any], error_type: ErrorType) -> List[Dict[str, Any]]:
        ...
        if error_type == ErrorType.PATH_BLOCKED:
            ...
            alternatives.extend([
                ...
                {'type': 'ask', 'question': 'Where can I find this?', 'reason': 'Asking for help'}
            ])
